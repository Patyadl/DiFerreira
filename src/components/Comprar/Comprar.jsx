...
function Comprar() {
  ...
  return (
    <div className="mt-48 md:mt-48">
      ...
      <section className="flex items-center justify-start container mt-0 pt-4 bg-gradient-to-b from-yellow-200 to-white py-12 sm:py-20">
        <h2 className="text-lg sm:text-xl md:text-2xl font-medium relative inline-block pl-6 pr-6 sm:pl-9 sm:pr-9">
          Camisa Palm Angels
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-28 items-center">
          ...
          <div className="flex flex-col items-center">
            <div className="relative h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] flex items-center justify-center">
              <img
                ...
                className="w-72 object-contain rounded-lg shadow-lg transition-all duration-300 cursor-zoom-in"
              />
              ...
              <button
                ...
                className="absolute top-1/2 left-4 transform -translate-y-1/2
                 bg-black/60 hover:bg-black/80 text-white px-3 py-1 rounded-full transition"
              >
                ‹
              </button>
          ...
          <div className="flex flex-col font-medium text-base sm:text-lg md:text-xl gap-4 sm:gap-6">
              ...
              {Object.keys(imagens).map((cor, i) => (
                <span
                  ...
                  className={`cursor-pointer hover:underline ${
                    corSelecionada === cor ? "text-black" : "text-black"
                  }`}
                >
            ...
            <p className="text-sm text-gray-600 -mt-2">à vista</p>

            <button className="bg-yellow-400 text-black font-medium text-base
             sm:text-lg px-6 py-2 rounded-full shadow-md hover:shadow-lg
             hover:-translate-y-0.5 active:translate-y-0.5 transition
              hover:bg-yellow-300 hover:text-gray-800 w-full sm:w-40">
              Comprar
            </button>
          </div>
        </div>
      ...
      {zoom && (
        ...
        >
          <img
            src={fotos[index]}
            alt="Zoom Camisa"
            className="max-w-[90%] max-h-[90%] object-contain rounded-lg cursor-zoom-out"
          />
        </div>
      )}
    </div>
