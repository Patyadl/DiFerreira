...
import fotoInsta from "../../Images/Rodape/image 27.png"

function Rodape() {
  return (
    <header className="bg-black text-#F1D43B py-12 sm:py-16 ">
  ...
  flex-wrap justify-between items-center gap-8 lg:gap-16 ">
    ...
    <section className="flex flex-col items-center lg:items-start text-center lg:text-left gap-6 w-full lg:w-auto">
